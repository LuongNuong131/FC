...
const stats = computed(() => ({
  ...
  positions: playerStore.players.reduce((acc, p) => {
  ...
  <div class="space-y-6">
    ...
    >
      <div class="absolute inset-0 opacity-20">
        ...
        ></div>
        <div
          class="absolute bottom-0 right-0 w-96 h-96 bg-yellow-200 rounded-full mix-blend-overlay filter blur-3xl animate-pulse"
    ...
    <div v-else class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div class="md:col-span-3 flex items-end space-x-2">
            ...
            <button
              ...
              :title="viewMode === 'grid' ? 'Chế độ lưới' : 'Chế độ danh sách'"
            >
              <svg
                v-if="viewMode === 'grid'"
                class="w-5 h-5"
      ...
      >
        <div
          class="inline-block p-8 bg-gradient-to-br from-yellow-50 to-orange-100 rounded-3xl mb-6"
        >
          <svg
            class="w-24 h-24 text-yellow-500 mx-auto"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          <div class="flex-shrink-0">
            <div class="relative">
              <img
                ...
                "
                :alt="player.name"
                class="w-20 h-20 rounded-full object-cover border-4 border-indigo-500 group-hover:border-purple-600 transition-colors"
                @error="
                  ($event) =>
                    ($event.target.src =
                      'https://placehold.co/150x150/e2e8f0/94a3b8?text=No+Image')
              ...
              />
              <div
                class="absolute -bottom-1 -right-1 w-8 h-8 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white font-black text-sm shadow-lg"
              >
                {{ player.jerseyNumber || "?" }}
              </div>
            </div>
          ...
          >
            ...
            <div class="flex items-center justify-end space-x-2">
              <router-link
                ...
                class="px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold rounded-lg hover:shadow-lg transition-all flex items-center"
              >
                <svg
                  class="w-4 h-4 mr-1"
                  fill="none"
